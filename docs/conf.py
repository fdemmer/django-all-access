...
copyright = '2012-%s, Mark Lavin & contributors' % datetime.date.today().year
...
version = '.'.join(allaccess.__version__.split('.')[0:2])
# The full version, including alpha/beta/rc tags.
release = allaccess.__version__
...
htmlhelp_basename = 'django-all-accessdoc'
